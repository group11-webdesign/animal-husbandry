	...
	<main class="my-form">
		<div class="cotainer">
			<div class="row justify-content-center">
				<div class="col-md-8">
					<div class="card">
					<div class="card-header" style="background-color:#22651D"><h4 style="font-style:bold;color:white">Register</h4></div>
						<div class="card-body border border-dark">
							<form name="my-form" action="BuyerRegistration.php" method="post">
								...
								<div class="col-md-6 offset-md-4">
									<button type="submit" class="btn btn-primary"  style="background-color:#22651D;color:white" name="register" value="Register">
										Register
									</button>
								</div>
							</form>
...
if (isset($_POST['register'])) {
	...
	if (strcmp($password, $confirmpassword) == 0) {
        ...
        buyer_bank,buyer_mail,buyer_username,buyer_password) 
		values ('$name','$phonenumber','$address','$company_name','$account',

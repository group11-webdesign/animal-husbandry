	...
	<main class="my-form">
		<div class="cotainer">
			<div class="row justify-content-center">
				<div class="col-md-8">
					<div class="card " >
						<div class="card-header text-left" style="background-color:#22651D">
						...
						<div class="card-body border border-dark">
							<form name="my-form" action="FarmerLogin.php" method="post">
								...
								<div class="col-md-6 offset-md-4">
									<button type="submit" class="btn btn-primary text-left border border-dark" style="background-color:#22651D;color:white" name="login" value="Login">
										Login
									</button>
								</div>
								<br>

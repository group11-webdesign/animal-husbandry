...
<body>
     ...
     <div class="whatsnew">
          ...
          <div class="f1 f4">
               <div class="t1 t4"> verve & OTHER OPTIONS</div>
     ...
     <div class="copy">
          <h5 style="text-align:center; padding-top:40px;margin-left:650px; background-color:'grey';">Copyright &copy; 2022 by www.AgroAllies.com</h5>
     </div>

...
<div class="container" >
    ...
    <div class="text-center"><h2><b>Edit Profile</h2></b></div>
        ...
        <button type="submit" class="btn text-center d-flex mx-auto btn-lg" style="background-color:#22651D;color:white">Confirm</button>
        <button type="button" class="btn text-center d-flex mx-auto btn-lg mt-4" style="background-color:#22651D;color:white">Change Password</button>
   <br>
   <button> </div>
</body>
</html>
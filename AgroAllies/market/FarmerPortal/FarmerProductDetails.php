          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
               ...
               <div class="list-group moblists">
                    ...
                    if (isset($_SESSION['phonenumber'])) {
                         ...
                         echo "<a href='Orders.php' class='list-group-item list-group-item-action' style='background-color:#22651D;text-align:center;color:white'>Orders</a>";
                                        ...
                                        <div class='col-md-6 blackgoldie'>
                                             <div class='row'>
                                                  <div class='col-md-12 bottom-rule aligncenter'>
                                                       <h1 style='color:white;padding:10px;'>$product_title</h1>
                                                  </div>
                                             </div>
                                             ...
                                             <div class='row' style='padding:7px;'>
                                                  <div class='row text-center ml-4 mt-3' >
                                                       <i class='fa fa-truck fa-2x' aria-hidden='true' style='color:white;'> </i>

...
<div class="address"><p class="state">newyork,USA</p>
  ...
  <div class="right-side">
     ...
     <div class='inputwrapper'>
          ...
          <label>PRICE:- $product_price Naira/kg</label><br>
          <label id='shop2'></label>$product_delivery<br>Qty:-
          <form action='' method='post'>
               <input class='numberinput' type='number' name='quantity' value='1'>
          </form>
          <a href='../BuyerPortal/BuyerHomepage.php?add_cart=$product_id'><button class='addtocart'>ADD TO CART <i class='fas fa-shopping-cart' style=' background-color:#22651d'></i></button></a><br><br>
     </div>

            ...
            while ($rows = mysqli_fetch_array($runa_query)) {
                ...
                <div class='container'>
                    ...
                    <div class='row'>
                        ...
                        <div class='col-12 col-xl-4 col-lg-4 col-md-4 col-sm-12 text-white' style='background-color:#22651D;'>
                            <div class='text-center farmerdetails mt-4 ' style='color:white'><b>
                                    <b>
                                        <h2>Farmer Details
                                        </h2>
                                    </b>

...
<nav class="navbar navbar-expand-xl ">
                                        ...
                                        <div class="input-group mb-3">
                                            <div class="input-group-prepend">
                                                <a href="AddQty.php?id=<?php echo $product_id; ?>">
                                                    <button class="btn btn-outline-secondary" style=" background-color:#22651D;" type="button" id="button-addon1">
                                            ...
                                            <div class="input-group-append">
                                                <a href="MinusQty.php?id=<?php echo $product_id; ?>">
                                                    <button class="btn btn-outline-secondary" style=" background-color:#22651D;" type="button" id="button-addon2">
    ...
    <div class="container">
        ...
        <div class=" float-none float-sm-none float-md-none float-lg-right float-xl-rightcheckout mr-0 p-2 border border-dark  " style="border-radius:5%;">
            ...
            <h2>Grand total = <?php echo $total; ?> Naira </h2>

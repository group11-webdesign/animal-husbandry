        ...
        <div class="container mt-2">
            ...
            <form>
                <div class=" float-none float-sm-none float-md-none float-lg-right float-xl-rightcheckout mr-0 p-2 mb-5   " style="border-radius:5%;">
                    <h4 style="font-family: sans-serif"><b>Grand total = <?php echo $_SESSION['grandtotal']; ?> Naira </b></h4>
                </div>
                <div class="input-group mt-2 hey ">
                    <div class="input-group-prepend ">
                        <span class="input-group-text" style="background-color:#22651D;color:white">Delivery Address</span>
                    </div>
                            ...
                            while ($phones = mysqli_fetch_array($run_get_phone)) {
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td data-label="Total (in Naira)"><?php echo $subtotal; ?></td>
                                        <?php

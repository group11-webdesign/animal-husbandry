        ...
        <div class="card-body text-center border" style="margin-top: 0px;">
			<form name="my-form" >
				<div class="form-group row" >
                    ...
                    <div class="col-md-6 " style="background-color:#22651D;">
                        <div class="row">
                                <div class="col-md-12 ">
                                    <span>
                                    ...
                                    <span>
                                        <h4 style='color:white;' class='text-center ''>Get Latest Notifications<br></h4>
                                    ...
                                    <span>
                                        <h4 style='color:white;' class='text-center ''>Report Query <br></h4>

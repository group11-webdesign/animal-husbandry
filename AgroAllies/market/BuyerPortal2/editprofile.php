...
<br>
    ...
    <div class="container" >
        ...
        <button type="button" class="btn text-center d-flex mx-auto btn-lg" style="background-color:#22651D;color:white">Confirm</button>
        <br>
        <button type="button" class="btn text-center d-flex mx-auto btn-lg" style="background-color:#22651D;color:white">Change Password</button>
    </div>

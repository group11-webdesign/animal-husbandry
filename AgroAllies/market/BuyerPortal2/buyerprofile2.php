...
<style>
    ...
    * {
    ...
    .guard {
        width: 100%;
        text-align: center;
        border-bottom: 1px solid #22651D;
...
<br>
    ...
    <div class="container" >
        ...
        <button type="button" class="btn text-center d-flex mx-auto btn-lg" style="background-color:#22651D;color:white">Edit Profile</button>
    </div>
